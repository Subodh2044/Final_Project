...
**Segment 1 (Subodh)**
We judiciously decided that we will explore and understand Airline Passenger Satisfaction Survey dataset by analyzing and creating dashboards in Tableau. Please click the link below to view dashboards.
